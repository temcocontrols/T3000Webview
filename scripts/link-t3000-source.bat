...
set "T3000_BAS_SOURCE=D:\1025\github\temcocontrols\T3000_Building_Automation_System"
set "WEBVIEW_PROJECT=%~dp0.."
set "LINK_TARGET=%WEBVIEW_PROJECT%\T3000_Building_Automation_System_Source"

echo === Creating T3000 C++ Source Link ===
echo T3000 C++ Source: %T3000_BAS_SOURCE%
echo WebView Project: %WEBVIEW_PROJECT%
echo Link Target: %LINK_TARGET%

REM Check if T3000 source exists
if not exist "%T3000_BAS_SOURCE%" (
    echo ERROR: T3000 C++ source directory not found at %T3000_BAS_SOURCE%
