...
describe('StateStore', () => {
  ...
  describe('Global Messages', () => {
    it('should manage global messages', () => {
      const message1 = new GlobalMsgModel('info', 'Test message 1', true, 'system');
      const message2 = new GlobalMsgModel('error', 'Test message 2', true, 'validation');
    ...
    it('should handle invalid message removal gracefully', () => {
      const message = new GlobalMsgModel('info', 'Test message', true, 'system');
    ...
    it('should clear all global messages', () => {
      stateStore.addGlobalMessage(new GlobalMsgModel('info', 'Test message 1', true, 'system'));
      stateStore.addGlobalMessage(new GlobalMsgModel('error', 'Test message 2', true, 'validation'));
  ...
  describe('Destroy Method', () => {
    it('should clean up all state when destroyed', () => {
      ...
      stateStore.addToRedoHistory({ state: 'test' });
      stateStore.addGlobalMessage(new GlobalMsgModel('info', 'Test', true, 'system'));
