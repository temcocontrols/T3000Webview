...
pub fn bridge_routes(router: Router<T3AppState>) -> Router<T3AppState> {
    ...
    router
        ...
        .route("/api/eez-device/images/pull/:panelId/:name", get(bacnet_api_mock::pull_image))
        .route("/api/eez-device/images/:panelId/:name", delete(bacnet_api_mock::delete_image))
