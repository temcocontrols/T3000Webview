...
export const appState = cloneDeep(emptyProject); // State for the application

// export const deviceAppState = ref([]);
export const deviceAppState = []; // State for the device application

// export const deviceModel = ref({ active: false, data: {} });
export const deviceModel = { active: false, data: {} }; // State for the device model

// export const rulersGridVisible = ref(true);
export const rulersGridVisible = true; // State for ruler and grid visibility

// export const user = ref(null);
export const user = null; // State for user information
...
export const library = cloneDeep(emptyLib); // State for the library

// export const isBuiltInEdge = ref(false);
export const isBuiltInEdge = false; // State for built-in edge detection
...
//   });
export const documentAreaPosition = {
  ...
  widthOffset: "128px",
  heightOffset: isBuiltInEdge ? "68px" : "115px",
};
...
// });
export const viewportMargins = {
  top: isBuiltInEdge ? 36 : 95 + 20 + 2,
  left: 106 + 20 + 2,
}; // Margins for the viewport

// export const viewport = ref(null); // Reference to the viewport element
export const viewport = null; // Reference to the viewport element

// export const locked = ref(false); // State to lock or unlock the interface
export const locked = false; // State to lock or unlock the interface
...
//   loadingPanel: null,
// });
export const T3000_Data = {
  panelsData: [],
  panelsList: [],
  panelsRanges: [],
  loadingPanel: null,
}; // Data for T3000 panels

// export const grpNav = ref([]); // Navigation history for grouped elements
export const grpNav = []; // Navigation history for grouped elements

// Panel options for selection
// export const selectPanelOptions = ref(T3000_Data.value.panelsData);
export const selectPanelOptions = T3000_Data.panelsData; // Panel options for selection

// export const linkT3EntryDialog = ref({ active: false, data: null }); // State of the link T3 entry dialog
export const linkT3EntryDialog = { active: false, data: null }; // State of the link T3 entry dialog

// export const savedNotify = ref(false); // Notification state for saving
export const savedNotify = false; // Notification state for saving

// export const undoHistory = ref([]); // History for undo actions
export const undoHistory = []; // History for undo actions

// export const redoHistory = ref([]); // History for redo actions
export const redoHistory = []; // History for redo actions

// export const moveable = ref(null); // Reference to the moveable component instance
export const moveable = null; // Reference to the moveable component instance
...
export const globalMsg = []; // Global message state

// export const devVersion = ref("V:25.0414.01");
export const devVersion = "V:25.0414.01"; // Version of the application

// export const localSettings = ref({ version: "V:25.0414.01", transform: 0 });
export const localSettings = { version: "V:25.0414.01", transform: 0 }; // Local settings for the application
