/**
 * Range Definitions for T3000 System
 * Separated from T3Data.ts as part of refactoring efforts
 *
 * Contains digital and analog range configurations for inputs, outputs, and variables
 */
...
export interface RangeDefinitions {
  ...
  analog: {
    input: AnalogRange[];
    output: AnalogRange[];
    variable: AnalogRange[];
  };
}

export const ranges: RangeDefinitions = {
  digital: [
    {
      id: 1,
      label: "Off/On",
...
export type T3Type = typeof T3_Types[keyof typeof T3_Types];
