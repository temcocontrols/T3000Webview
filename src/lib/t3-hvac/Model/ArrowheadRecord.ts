 ...
 *
 * LogUtil.Debug(`Start Arrow: ID=${arrowRecord.StartArrowID}, Display=${arrowRecord.StartArrowDisp}`);
 * LogUtil.Debug(`End Arrow: ID=${arrowRecord.EndArrowID}, Display=${arrowRecord.EndArrowDisp}`);
 *
