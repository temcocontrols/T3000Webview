...
const TOOL_DESCRIPTIONS: Record<string, string> = {
  ...
  t3000_fdd_rules_list: 'Listing fault detection rules\u2026',
  t3000_fdd_analyze: 'Running fault detection\u2026',
  t3000_fdd_rule_create: 'Creating fault detection rule\u2026',
  t3000_fdd_rule_update: 'Updating fault detection rule\u2026',
  t3000_fdd_rule_toggle: 'Toggling fault detection rule\u2026',
  t3000_fdd_rule_export: 'Exporting fault detection rules\u2026',
  t3000_fdd_rule_import: 'Importing fault detection rules\u2026',
  t3000_fdd_faults: 'Listing fault detection findings\u2026',
