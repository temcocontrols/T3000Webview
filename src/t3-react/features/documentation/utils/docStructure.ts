...
export const docStructure: DocSection[] = [
  ...
  },
  {
    ...
    icon: 'Code',
    items: [
      { title: 'Overview', path: 't3000/api-reference/overview' },
      { title: 'Device Management', path: 't3000/api-reference/device-management' },
      { title: 'Data Points', path: 't3000/api-reference/data-points' },
      { title: 'Control & Automation', path: 't3000/api-reference/control-automation' },
      { title: 'Trend Logging', path: 't3000/api-reference/trendlogs' },
      { title: 'Generic Tables', path: 't3000/api-reference/generic-tables' },
      { title: 'Database Management', path: 't3000/api-reference/database-management' },
      { title: 'Developer Tools', path: 't3000/api-reference/developer-tools' },
      { title: 'System & Utilities', path: 't3000/api-reference/system-utilities' },
    ],
  },
  {
    title: 'Guides',
