...
import {
    ...
    Dropdown, Option, OptionGroup, Tooltip,
...
const RulesTab: React.FC = () => {
    ...
    const columns: TableColumnDefinition<FddRule>[] = [
        createTableColumn({
            columnId: 'rule', renderHeaderCell: () => 'Rule', renderCell: (r) => (
        ...
        createTableColumn({
            columnId: 'kind', renderHeaderCell: () => 'Kind', renderCell: (r) => (
        ...
        createTableColumn({
            columnId: 'roles', renderHeaderCell: () => 'Required Roles', renderCell: (r) => (
        ...
        createTableColumn({
            columnId: 'severity', renderHeaderCell: () => 'Severity', renderCell: (r) => (
                <Badge appearance="filled" color={sevColor(r.severity)} className={sevBadgeClass(r.severity)} size="small">
                    {r.severity}
                </Badge>
            )
        ...
        createTableColumn({
            columnId: 'enabled', renderHeaderCell: () => 'Enabled', renderCell: (r) => (
                <Switch checked={r.enabled} onChange={() => handleToggle(r)} className={styles.switchScale} />
            )
        }),
        createTableColumn({
            columnId: 'actions', renderHeaderCell: () => '', renderCell: (r) => {
...
const FindingsTab: React.FC = () => {
    ...
    const columns: TableColumnDefinition<FddFinding>[] = [
        createTableColumn({
            columnId: 'device', renderHeaderCell: () => 'Device', renderCell: (f) => (
                <div>
        ...
        createTableColumn({
            columnId: 'rule', renderHeaderCell: () => 'Rule', renderCell: (f) => (
                <div>
        ...
        createTableColumn({
            columnId: 'severity', renderHeaderCell: () => 'Severity', renderCell: (f) => (
                <Badge appearance="filled" color={sevColor(f.severity)} className={sevBadgeClass(f.severity)} size="small">{f.severity}</Badge>
            )
        }),
        createTableColumn({
            columnId: 'hours', renderHeaderCell: () => 'Fault Hours', renderCell: (f) => (
        ...
        createTableColumn({
            columnId: 'evidence', renderHeaderCell: () => 'Evidence', renderCell: (f) => (
        ...
        createTableColumn({
            columnId: 'created', renderHeaderCell: () => 'Detected At', renderCell: (f) => (
