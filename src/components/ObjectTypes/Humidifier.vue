...
<template>
  <svg viewBox="0 0 18 25" height="100%" width="100%" version="1.1" xmlns="http://www.w3.org/2000/svg"
    xmlns:bx="https://boxy-svg.com" :class="{'inactive': !active, 'active': active, 'in-alarm': inAlarm}">
...
.active .duct-humidifier .water-drops {
  transform: translate(-10px);
  animation: duct-humidifier-drop-move 1s linear infinite;
}

.inactive .duct-humidifier .water-drops {
  opacity: 0;
}

.active .duct-humidifier .water-drops-2 {
