...
var ASM_CONSTS = {
  1089792: ($0) => { startToDebuggerMessage($0); },  
 1089824: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1089899: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1089974: ($0) => { finishToDebuggerMessage($0); },  
 1090007: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1090037: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1090067: ($0) => { lvglScreenTick($0); },  
 1090091: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1090131: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1090185: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1090239: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1090292: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1090345: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1090398: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1090450: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1090497: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1090530: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1090566: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1090611: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1090717: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1090753: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1090790: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1090830: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1090887: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1090946: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
